...
**Focus Filter** is a custom filter list designed for **AdGuard**. Its primary goal is to remove recommended feeds, distracting elements, and "doom-scrolling" traps from various websites  (focusing on **Chinese platforms**), allowing you to focus on the content you actually want to watch.
